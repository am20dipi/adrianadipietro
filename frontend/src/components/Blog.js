                ...
                <div className="card" id="blog">
                    <div className="card-body">
                        ...
                        <p className="card-text text-muted">
                            As the third installment of the series on How To: Build A Linked List, this article focuses on 
                    ...
                    <p className="card-text bg-light"><small className="text-muted">Posted on January 25</small></p>
                </div>
                <div className="card" id="blog">
                    <div className="card-body">
                    ...
                    <p className="card-text bg-light"><small className="text-muted">Posted on December 28</small></p>
                </div>
                <div className="card" id="blog">
                    <div className="card-body">
                    ...
                    <p className="card-text bg-light"><small className="text-muted">Posted on November 14</small></p>
                </div>
            </div>
        </div>
