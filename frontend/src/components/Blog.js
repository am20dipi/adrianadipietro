        ...
        <div className="container">
            ...
            <div className="card-deck">
                <div className="card">
                    ...
                    <p class="card-text bg-light"><small class="text-muted">Posted on January 25</small></p>
                </div>
                <div className="card">
                    <div className="card-body">
                    ...
                    <p class="card-text bg-light"><small class="text-muted">Posted on December 28</small></p>
                </div>
                <div className="card">
                    <div className="card-body">
                    ...
                    <p class="card-text bg-light"><small class="text-muted">Posted on November 14</small></p>
                </div>
            </div>
        </div>
