    ...
    return (
        <section>
            <div className="container">
                ...
                <div className="badge-base LI-profile-badge" data-locale="en_US" data-size="medium" data-theme="light" data-type="VERTICAL" data-vanity="adriana-dipietro" data-version="v1"><a className="badge-base__link LI-simple-link" href="https://www.linkedin.com/in/adriana-dipietro?trk=profile-badge"></a></div>
                {/* <i className="fa fa-github" ></i><a href="https://www.github.com/am20dipi/" target="_blank" rel="noopener noreferrer" className="card-link">Github</a> */}
            </div>
        </section>
    )
}
